---
title: "API Overview"
description: "HTTP API for building on top of arden."
---
...
| [Facts and Wiki](/api-reference/memory) | `/admin/facts*`, `/admin/wiki/pages*` | Read-only facts and versioned managed wiki pages |
