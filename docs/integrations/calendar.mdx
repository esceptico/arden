...
Import/paste your Google OAuth Desktop app credentials in the assistant, then click **Add account**. Arden opens the local browser OAuth flow and saves a token under `~/.arden/`.
