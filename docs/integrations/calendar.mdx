...
| `calendar_create_event` | Create an event (requires approval) |
| `calendar_edit_event` | Edit an event (requires approval) |
| `calendar_delete_event` | Delete an event (requires approval) |
