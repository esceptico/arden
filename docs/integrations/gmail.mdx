...
- **All current Google services** — legacy full arden scope set, including Pub/Sub
...
arden saves the normalized credentials to `~/.arden/gmail_credentials.json`.

### Add account

Click **Add account**. Arden opens a local browser OAuth consent flow and saves the token under `~/.arden/`.
