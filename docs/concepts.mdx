...
`area_submit_report`, which atomically commits its work, evidence, at most three
...
| `automation_create` | Recurring scheduled or event-driven work |
| `loop_create` | Adaptive repeated work in this chat that stops on a condition |
