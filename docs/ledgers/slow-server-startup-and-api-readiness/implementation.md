...
- [x] **I-07 — Bound new transcript/event writes**
  ...
  - Implemented: durable database-backed event pruning, content-addressed raw-result refs, declared-expiry pruning, deduplicated-blob grace renewal, and lock-protected allowlisted orphan deletion.
...
- [x] **I-09 — Pilot cold transcript bundles**
...
- [x] **I-10 — Explicit offline legacy migration and compaction**
