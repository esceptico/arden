...
arden ships with system automations that run automatically, such as memory consolidation, synthesis, and the slice suggester. They appear in the **System** tab. What they do is fixed, but their schedule is yours: adjust the cadence, pause, or run now.
