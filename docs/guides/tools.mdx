...
Wiki pages are the readable, managed projection. Use the read tools to discover
and inspect pages; generated publishing is reserved for an explicit automation.
