...
from arden.memory.artifacts import ARTIFACT_DIR_KINDS, ROOT_ARTIFACTS, ArtifactMemoryStore
...
from arden.memory.scopes import MemoryScope, apply_scope_to_source, scope_for_write, scopes_for_read
from arden.tools.core import ToolResult, tool
from arden.tools.core.context import ToolExecution
from arden.tools.core.file_mutation import RevisionConflict, atomic_compare_and_swap, revision_or_absent
...
_ENGINE_MEMORY_PATHS = {"raw", ".arden", ".index", ".maintenance"}
...
def _entity_brief_nudge(query: str) -> str | None:
    ...
    from arden.memory.artifacts import _slug
