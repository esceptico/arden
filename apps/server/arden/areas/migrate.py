...
from arden.constants import AREAS_STATE_FILE, AREAS_SUGGESTIONS_FILE
from arden.logging import get_logger

_logger = get_logger(__name__)


def migrate_state_files(arden_dir: Path) -> None:
    ...
    old_state = arden_dir / "slices-state.json"
    new_state = arden_dir / AREAS_STATE_FILE
    ...
    old_sugg = arden_dir / "slices-suggestions.json"
    new_sugg = arden_dir / AREAS_SUGGESTIONS_FILE
