...
DROP INDEX IF EXISTS idx_wiki_maintenance_one_pending_per_commit;
    ...
    async def resolve(
        ...
        *,
        ...
        async with self._lock:
            ...
            if action is WikiMaintenanceReviewAction.ACCEPT and existing.proposal_json is None:
                raise ValueError("a non-executable review cannot be accepted")
            cursor = await self._conn.execute(
                """
                UPDATE wiki_maintenance_reviews
