...
class _OAuthCallbackHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if parsed.path == "/cancel":
            ...
            self._html(200, "Authorization Cancelled", "You can close this window and return to arden.", error=True)
            _stop_server_async()
            return
        ...
        try:
            ...
            self._html(200, "Authorization Successful", "You can close this window and return to arden.")
...
<html>
  <head>
    <title>Arden - OpenAI Authorization</title>
    <style>
      body {{
